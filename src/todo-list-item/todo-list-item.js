...
const TodoListItem = ({label, onDeleted,
    onToggleDone, onToggleImportant,
        ...
        if(done) {
            classNames += ' done';
            const d = new Date();
            completionData = `Задача завершена: ${d.getDate()}.${d.getDate()}.${d.getFullYear()} ${d.getHours()}:${d.getMinutes()}`
        }
        ...
        return (
            <div className='todo-list-row'>
                ...
                <button
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-57 0 512 512" width="512pt">
                ...
                <div className="todo-item-data">
                    <div className='todo-item-data__creation'>Задача создана: {data}</div>
                    <div className="todo-item-data__completion">{completionData}</div>
                </div>
            </div>
        )
}
